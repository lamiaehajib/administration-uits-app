...
class CategoryController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $stats = [
            ...
            })->sum(DB::raw('COALESCE(NULLIF(total_apres_remise, 0), sous_total)')),
        ];
    ...
    private function calculateCategoryStats($category)
    {
        ...
        $category->ca_total = DB::table('recu_items')
            ...
            ->sum(DB::raw('COALESCE(NULLIF(recu_items.total_apres_remise, 0), recu_items.sous_total)'));
    ...
    public function show($id)
    {
        ...
        $topProduits = DB::table('produits')
            ...
            ->select(
                ...
                DB::raw('SUM(COALESCE(NULLIF(recu_items.total_apres_remise, 0), recu_items.sous_total)) as ca_total'),
        ...
        $ventesParMois = DB::table('recu_items')
            ...
            ->select(
                ...
                DB::raw('SUM(COALESCE(NULLIF(recu_items.total_apres_remise, 0), recu_items.sous_total)) as ca'),
