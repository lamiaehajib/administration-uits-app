...
<body>
    ...
    <div>
        <h4 class="header-img" >S.N°: {{ $attestation->numero_de_serie }}
        </h4>
    </div>
    ...
    <div class="divb">
        <p class="pb">Il a subi avec succès toutes les épreuves prévues pour l'obtention de l'attestation de la formation 
            <<< <span class="spanb">{{ $attestation->formation_name }}</span> >>>.
        </p>
    </div>
    ...
    <div style="position: absolute; margin-left:770px; font-weight: bold;
            font-size: 1rem;
            color: rgb(214, 20, 20); margin-top:-20px;">
    ...
    <div style="text-align: center;margin-top:100px; ">
        <hr style="border: none; border-top: 2px solid #df0202; margin: 10px auto; width: 70%;" />
        <footer>
