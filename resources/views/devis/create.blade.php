    ...
    <div class="create-container px-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h2 class="gradient-text mb-1" style="font-size: 32px; font-weight: 700;">
                    <i class="fas fa-plus-circle"></i> Créer un Nouveau Devis
                </h2>
                <p class="text-muted mb-0">Remplissez les informations pour générer votre devis</p>
            </div>
        ...
        <form action="{{ route('devis.store') }}" method="POST" id="devis-form">
            ...
            <div class="form-card fade-in">
                ...
                <div class="mb-3">
                    <label class="form-label">Titre du Devis <span class="required">*</span></label>
                    <input type="text" name="titre" class="form-control" placeholder="Ex: Développement site web e-commerce" value="{{ old('titre') }}" required>
                </div>
                ...
                <div class="grid-3 mb-3">
                    ...
                    <div>
                        ...
                        <input type="text" name="contact" class="form-control" placeholder="Email ou téléphone" value="{{ old('contact') }}">
                    </div>
                    <div>
                        <label class="form-label">Référence</label>
                        <input type="text" name="ref" class="form-control" placeholder="Référence interne" value="{{ old('ref') }}">
                    </div>
                </div>
            </div>
                ...
                <div id="product-container">
                    <div class="product-row fade-in">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="libele[]" class="form-control" rows="3" placeholder="Description détaillée du produit ou service..." required>{{ old('libele.0') }}</textarea>
                        </div>
            ...
            <div class="form-card fade-in">
                ...
                <input type="hidden" name="total_ht" id="total_ht" value="{{ old('total_ht') }}">
                <input type="hidden" name="total_ttc" id="total_ttc" value="{{ old('total_ttc') }}">
            </div>
            ...
            <div class="form-card fade-in">
                ...
                <div id="important-container">
                    <div class="important-row fade-in">
                        ...
                        <input type="text" name="important[]" class="form-control" placeholder="Ex: Délai de livraison: 15 jours" value="{{ old('important.0') }}">
    ...
    function addProduct() {
        ...
        newRow.innerHTML = `
            ...
            <div class="grid-4">
                ...
                <div>
                    <label class="form-label">Prix Unitaire <span class="required">*</span></label>
                    <input type="number" step="0.01" name="prix_unitaire[]" class="form-control unit-price" value="0" min="0" oninput="calculatePrixTotal()" required>
                </div>
                <div>
                    <label class="form-label">Prix Total</label>
                    <input type="number" step="0.01" name="prix_total[]" class="form-control total-price" readonly>
