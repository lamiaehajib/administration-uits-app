...
<body>
    <div class="content-container">
        <div style="display: flex; justify-content: space-between; align-items: center;">
            ...
            <div style="margin-left:250px; margin-top:30px !important;width=70px;height:40px !important ; position: absolute;">
                <img width="50px" style="margin-left:190px; margin-top:30px !important; " src="{{ public_path('images/scanie-r.jpg') }}" alt="Logo"/>
             </div>
        </div>
        ...
        <div style="margin-top: 100px;">
            ...
            <div class="section" style="display: flex; justify-content: space-between;">
                <span style="font-weight: 500;text-transform: uppercase;">Durée de stage :</span>
                <span class="dotted-line">{{ $reussite->duree_stage }}</span>
            </div>
            <div class="section" style="display: flex; justify-content: space-between;">
    ...
    <div class="section" style="display: flex; justify-content: space-between;">
        <span  style="font-weight: 500;text-transform: uppercase;">Montant :</span>
        <span class="dotted-line">{{ $reussite->montant_paye }}DH</span>
    </div>
